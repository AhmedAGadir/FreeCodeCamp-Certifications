...
let allHeadings = [...document.querySelectorAll('.documentation > section > header'),...document.querySelectorAll('.documentation > section > div > h3')];
...
allHeadings.forEach(heading => {
  ...
  heading.firstElementChild.addEventListener('click', () => window.location = `index.html#${heading.textContent.toLowerCase().replace(/\s/g, '_')}`)
});
